      ...
      <div className="col-lg-6 wow animate fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
        <div className="banner-right-content">
          <div className="section-title-4">
            ...
            <p>We architect robust, scalable digital ecosystems that transform enterprise workflows and drive measurable business growth. By uniting deep domain expertise in cloud infrastructure, AI automation, and bespoke software development, we help modern companies innovate faster and operate with unprecedented reliability.</p>
            <p>From building resilient microservices to implementing high-precision generative AI pipelines, our engineering standards guarantee rapid time-to-market without compromising code quality, security compliance, or performance.</p>
        ...
        <div className="col-lg-6 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
          <div className="about-left-content">
            <div className="section-title-4">
              ...
              <p>Accelerate your product roadmap with end-to-end software development, zero-trust cloud architectures, and dedicated engineering pods tailored to your exact business objectives.</p>
            </div>
