              ...
              <div className="col-lg-12 col-md-6 border-bottom1">
                <div className="home6-case-study">
                  ...
                  <div className="case-content pb-50">
                    ...
                    <p>Migrated legacy monolithic infrastructure to automated AWS Kubernetes clusters, slashing latency by 45% and reducing cloud spend.</p>
              ...
              <div className="col-lg-12 col-md-6">
                <div className="home6-case-study">
                  ...
                  <div className="case-content">
                    ...
                    <p>Engineered cross-platform Flutter and React Native mobile applications with offline sync and biometrics for fintech clients.</p>
                    <div className="learn-btn">
                    <Link legacyBehavior href="/case-study-details">
                        <a className="primary-btn9">
                        <span>Learn More</span>
              ...
              <div className="col-lg-12 col-md-6 border-bottom2">
                <div className="home6-case-study pb-50">
                  ...
                  <div className="case-content">
                    ...
                    <p>Delivered executive technical consulting and AI roadmap strategy, establishing secure MLOps pipelines for rapid prototyping.</p>
                    <div className="learn-btn">
                    <Link legacyBehavior href="/case-study-details">
                        <a className="primary-btn9">
                        <span>Learn More</span>
              ...
              <div className="col-lg-12 col-md-6">
                <div className="home6-case-study">
                  ...
                  <div className="case-content">
                    <span>CLOUD HOSTING</span>
                    <h3><Link legacyBehavior href="/case-study-details"><a>Unlocking Scalability, Reliability, and Efficiency.</a></Link></h3>
                    <p>Architected multi-region serverless failover networks with 99.99% SLA availability and edge caching for global users.</p>
                    <div className="learn-btn">
                    <Link legacyBehavior href="/case-study-details">
                        <a className="primary-btn9">
                        <span>Learn More</span>
