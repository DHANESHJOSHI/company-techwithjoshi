    ...
    <>
      ...
      >
        <div className="siderbar-top">
          <div className="sidebar-log">
            <Link legacyBehavior href="/">
              <a>
                <img src="/assets/img/techwithjoshi-logo.svg?v=4" alt="TechWithJoshi" style={{ height: "38px", width: "auto" }} />
              </a>
            </Link>
          </div>
        ...
        <div className="sidebar-content">
          <p>
            Empowering modern enterprises with cutting-edge software engineering,
            intelligent AI systems, and robust cloud infrastructure designed to scale.
          </p>
        </div>
          ...
          <div className="content">
            <div className="informations">
              ...
              <div className="single-info">
                ...
                <div className="info">
                  <a href={`mailto:${settings.emailPrimary || "work@techwithjoshi.in"}`}>{settings.emailPrimary || "work@techwithjoshi.in"}</a>
          ...
          <Link legacyBehavior href="/">
            <a>
              <img
                alt="TechWithJoshi"
                className="img-fluid"
                src="/assets/img/techwithjoshi-logo.svg?v=4"
        ...
        >
          ...
          <div className="d-lg-none d-block">
            ...
            <div className="header-btn5">
              <Link legacyBehavior href="/contact">
                <a className="primary-btn3">Schedule Meeting</a>
              </Link>
            </div>
          </div>
        </div>
