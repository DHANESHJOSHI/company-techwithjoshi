          ...
          <div className="content">
            <div className="informations">
              <div className="single-info">
                ...
                <div className="info">
                  <p>
                    Shanoo Digital Photo Studio, Government Polytechnic, College Road, Dahod, Usarvan Part, Gujarat 389151
                  </p>
                </div>
              </div>
              <div className="single-info">
        ...
        <div className="follow-area">
          ...
          <div className="blog-widget-body">
            <ul className="follow-list d-flex flex-row align-items-start gap-4">
              <li>
                <a href="https://www.linkedin.com/in/dhanesh-joshi/" target="_blank" rel="noopener noreferrer">
                  <i className="bx bxl-linkedin" />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/its_dhanesh_joshi_/" target="_blank" rel="noopener noreferrer">
      ...
      >
        ...
        <div className={`main-menu ${state.isSidebarOpen ? "show-menu" : ""}`}>
          ...
          <ul className="menu-list">
            ...
            <li
              className={`${
                ["/service", "/service-details"].includes(currentRoute)
                  ? "active"
                  : ""
              }`}
            >
