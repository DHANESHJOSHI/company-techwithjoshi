...
function Footer3() {
        ...
        <div className="col-lg-12">
          <div className="footer-top-content">
            <div className="footer-logo">
              <Link legacyBehavior href="/"><a><img className="img-fluid" src="/assets/img/techwithjoshi-logo.svg?v=4" alt={settings.siteName || "TechWithJoshi"} style={{ height: "40px", width: "auto" }} /></a></Link>
            </div>
  ...
  <div className="container">
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-4 col-sm-6 d-flex">
        <div className="footer-widget">
          <div className="footer-contact mb-40">
            ...
            <a href="#">{settings.address || "Shanoo Digital Photo Studio, Government Polytechnic, College Road, Dahod, Usarvan Part, Gujarat 389151"}</a>
          </div>
          <div className="footer-contact mb-40">
            <h4>
            ...
            <a href={`mailto:${settings.emailPrimary || "work@techwithjoshi.in"}`}>{settings.emailPrimary || "work@techwithjoshi.in"}</a><br />
            <a href={`mailto:${settings.emailSecondary || "dhaneshjoshi1234@gmail.com"}`}>{settings.emailSecondary || "dhaneshjoshi1234@gmail.com"}</a>
          </div>
          <div className="footer-contact">
            <h6>See Our New updates</h6>
            <form onSubmit={(e) => { e.preventDefault(); alert("Thank you for subscribing to TechWithJoshi updates!"); }}>
        ...
        <div className="footer-widget">
          ...
          <div className="menu-container">
            <ul>
              ...
              <li><Link legacyBehavior href="/service"><a>Services &amp; Solutions</a></Link></li>
              <li><Link legacyBehavior href="/project"><a>Case Studies</a></Link></li>
      ...
      <div className="col-lg-2 col-sm-6 d-flex justify-content-lg-start justify-content-sm-start">
        <div className="footer-widget">
          <div className="widget-title">
            <h4>Solutions</h4>
          </div>
          <div className="menu-container">
            <ul>
              <li><Link legacyBehavior href="/service"><a>Web Engineering</a></Link></li>
              <li><Link legacyBehavior href="/service"><a>Cloud &amp; DevOps</a></Link></li>
              <li><Link legacyBehavior href="/service"><a>AI Agents &amp; LLMs</a></Link></li>
              <li><Link legacyBehavior href="/service"><a>Mobile Applications</a></Link></li>
              <li><Link legacyBehavior href="/service"><a>Cyber Resilience</a></Link></li>
            </ul>
          </div>
        </div>
      </div>
      <div className="col-lg-3 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
        <div className="footer-widget">
          ...
          <p style={{ fontSize: "14px", color: "#94a3b8", lineHeight: 1.6 }}>
            {settings.address || "Shanoo Digital Photo Studio, Government Polytechnic, College Road, Dahod, Usarvan Part, Gujarat 389151"}
          </p>
          <div style={{ marginTop: "16px" }}>
            <a
              href={settings.calLink || "https://cal.com/dhanesh-joshi/30min"}
              target="_blank"
              rel="noopener noreferrer"
              className="primary-btn3"
              style={{ padding: "8px 18px", fontSize: "13px", display: "inline-block" }}
            >
              Book 30-Min Call
            </a>
          </div>
        ...
        <div className="col-lg-12">
          <div className="footer-btn-content">
            <div className="copyright-area">
              <p>{settings.copyright || `©Copyright 2026 TechWithJoshi | All Rights Reserved`}</p>
            </div>
            <div className="footer-social">
              <ul>
                <li><a href={settings.linkedin || "https://www.linkedin.com/in/dhanesh-joshi/"} target="_blank" rel="noopener noreferrer"><i className="bx bxl-linkedin" /></a></li>
                <li><a href={settings.instagram || "https://www.instagram.com/its_dhanesh_joshi_/"} target="_blank" rel="noopener noreferrer"><i className="bx bxl-instagram" /></a></li>
              </ul>
            </div>
          </div>
        </div>
