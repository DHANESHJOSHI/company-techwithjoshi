            ...
            <div className="footer-top-content">
              <div className="footer-logo">
                <Link legacyBehavior href="/">
                  <a><img className="img-fluid" src="/assets/img/techwithjoshi-logo.svg?v=4" alt="TechWithJoshi" style={{ height: "40px", width: "auto" }} /></a>
                </Link>
              </div>
          ...
          <div className="col-lg-12">
            <div className="footer-btn-content">
              <div className="copyright-area">
                <p>©Copyright 2025 <a href="#">TechWithJoshi</a> | All Rights Reserved</p>
              </div>
