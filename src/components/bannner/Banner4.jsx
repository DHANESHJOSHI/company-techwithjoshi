        ...
        <div className="row">
          <div className="col-lg-7">
            <div className="banner-content">
              ...
              <p>
                We build next-generation web platforms, AI integrations, and cloud infrastructure that accelerate digital growth and give your business a decisive competitive edge.
              </p>
