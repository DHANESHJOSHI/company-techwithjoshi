                      ...
                      <div className="case-content">
                        ...
                        <h3>
                          <Link legacyBehavior href="/case-study-details">
                            <a>
                              Enterprise Microservices &amp; Cloud-Native Scaling
                            </a>
                          </Link>
                        </h3>
                        <p>
                          Architected resilient multi-region Kubernetes clusters on AWS with automated telemetry, reducing API latency by 42% and achieving 99.995% uptime.
                        </p>
                    ...
                    <div className="col-lg-7 d-flex align-items-center">
                      <div className="case-content">
                        ...
                        <h3>
                          <Link legacyBehavior href="/case-study-details">
                            <a>
                              Autonomous Enterprise LLM Workflow Engine
                            </a>
                          </Link>
                        </h3>
                        <p>
                          Designed high-throughput vector retrieval and fine-tuned agent workflows that automated 60% of manual document review operations.
                        </p>
                        <div className="learn-btn">
                          <Link legacyBehavior href="/case-study-details">
                            <a className="primary-btn9">
                    ...
                    <div className="col-lg-7 d-flex align-items-center">
                      <div className="case-content">
                        ...
                        <h3>
                          <Link legacyBehavior href="/case-study-details">
                            <a>
                              Real-Time FinTech Analytics &amp; Trading Dashboard
                            </a>
                          </Link>
                        </h3>
                        <p>
                          Engineered a reactive Next.js and Go backend platform handling 25M+ daily transaction requests with sub-15ms execution latency.
                        </p>
                        <div className="learn-btn">
                          <Link legacyBehavior href="/case-study-details">
                            <a className="primary-btn9">
