  ...
  return (
    <Layout>
      <Breadcrumb
        ...
        title="Exploring The TechWithJoshi Blog"
                    ...
                    <div className="blog-content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/blog-details">
                          <a>Building Resilient Event-Driven Microservices in Go &amp; Node.js</a>
                        </Link>
                      </h4>
                      <p>
                        Explore how distributed message brokers like Kafka and RabbitMQ eliminate bottlenecks in high-throughput enterprise pipelines.
                      </p>
                ...
                >
                  <div className="single-blog magnetic-item">
                    ...
                    <div className="blog-content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/blog-details">
                          <a>Modern Next.js &amp; Headless CMS Architecture for Startups.</a>
                        </Link>
                      </h4>
                      <p>
                        Discover how Next.js hybrid rendering patterns and global edge delivery achieve sub-second LCP and superior Core Web Vitals.
                      </p>
                      <div className="blog-footer">
                        <div className="read-btn">
                          <Link legacyBehavior href="/blog-details">
                ...
                >
                  <div className="single-blog magnetic-item">
                    ...
                    <div className="blog-content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/blog-details">
                          <a>Navigating the Journey of Cloud-Native Optimization.</a>
                        </Link>
                      </h4>
                      <p>
                        A comprehensive architectural roadmap for containerizing workloads, cutting cloud costs, and securing multi-region Kubernetes clusters.
                      </p>
                      <div className="blog-footer">
                        <div className="read-btn">
                          <Link legacyBehavior href="/blog-details">
                ...
                >
                  <div className="single-blog magnetic-item">
                    ...
                    <div className="blog-content">
                      ...
                      <h4>
                        <Link legacyBehavior href="/blog-details">
                          <a>Accelerating Enterprise Engineering with Generative AI.</a>
                        </Link>
                      </h4>
                      <p>
                        Learn how forward-thinking software squads integrate automated LLM pipelines for code generation, semantic search, and customer intelligence.
                      </p>
                      <div className="blog-footer">
                        <div className="read-btn">
                          <Link legacyBehavior href="/blog-details">
